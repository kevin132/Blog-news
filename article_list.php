...
<head>
     ...
     <title><?php if (isset($currentCategory)): ?><?php echo $currentCategory['name']; ?><?php else : ?>Tous les articles<?php endif; ?>
         ...
         <?php require('partials/nav.php'); ?>
          ...
          <main class="col-9">
               <section class="all_aricles">
                    <header>
                         <!-- si on affiche une catégorie, affichage de son nom, sinon affichage de "tous les articles" -->
                         <h1 class="mb-4"><?php if (isset($currentCategory)): ?><?php echo $currentCategory['name']; ?><?php else : ?>Tous les articles<?php endif; ?>
                              :</h1>
                    </header>
                   ...
                   <?php if(!empty($currentCategory['image'])): ?>
                        <div class="col-12">
                             <img class="img-fluid" src="img/article/<?php echo $category['image']; ?>" alt="<?php echo $article['title']; ?>" />
                        </div>
                   <?php endif; ?>
                                 ...
                                 <?php if (!empty($article['image'])): ?>
                                      <div class="row">
                                           ...
                                           <div class="col-12 col-md-4 col-lg-2">
                                                <img class="img-fluid"
                                                     src="img/article/<?php echo $article['image']; ?>"
